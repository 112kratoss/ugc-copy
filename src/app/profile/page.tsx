    ...
    <div className="ui-page ui-page-ambient min-h-screen">
      <div className="studio-shell relative z-10 py-8">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-zinc-400">
                {isFirstRunProfile
                  ...
                  : 'Review your posts, saved inspiration, private creations, and public creator identity in one place.'}
              </p>
            </div>
          </div>
        ...
        <section id="profile-settings" className="scroll-mt-24">
          <div className="mb-4">
            <div className="text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">Profile settings</div>
            <h2 className="mt-2 text-2xl font-semibold tracking-tight text-white">Public identity and links</h2>
          </div>
