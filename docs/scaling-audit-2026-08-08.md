...
| F7b | Fact retention + partitioning | High | 1 | IN PROGRESS | Retention 400→30 (decision #2), `feed_delivery_facts` added to growth reporting, a retention-lag monitor, and the **daily rollup** (`feed_delivery_fact_daily`, 400-day window) — 2026-08-09. The 2026-08-27 deadline is **discharged**. **Still open:** monthly partitioning only |
...
**Status:** IN PROGRESS — retention, monitoring and **daily aggregates** landed 2026-08-09; **only monthly partitioning is still open** · **Severity:** High · **Surface:** migration
