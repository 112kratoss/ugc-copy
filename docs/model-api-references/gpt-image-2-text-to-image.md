...
```json
{
  ...
  "data": {
    ...
    "model": "gpt-image-2-text-to-image",
    "state": "waiting",
    "param": "{\"model\":\"gpt-image-2-text-to-image\",\"input\":{\"prompt\":\"Generate an image of a funny guy that is live-streaming on tiktok and has 3d cartoon characters around him - design something funny.\",\"aspect_ratio\":\"auto\",\"resolution\":\"1K\"}}",
