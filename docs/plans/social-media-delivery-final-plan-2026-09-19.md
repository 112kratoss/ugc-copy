...
| 3 View count (OTA) | Tab-screen layout detach, icon rasters (892 → 740 views), neighbour-chrome detach | Same JS; the detach also trims the swipe’s layout | Done, shipped in 0.1.5; S24 re-measure of the neighbour detach pending USB authorisation |
