...
const extendedOperationCases: Array<{
  ...
  { key: 'fetchModelCatalogCurrent', call: (api) => api.fetchModelCatalogCurrent() },
  { key: 'fetchModelCatalogPage', call: (api) => api.fetchModelCatalogPage('revision=test&kind=image') },
  { key: 'fetchModelCatalogDetails', call: (api) => api.fetchModelCatalogDetails('revision=test&ids=model-1') },
  { key: 'fetchModelCatalogModel', call: (api) => api.fetchModelCatalogModel('model-1', 'revision=test') },
