...
- **Stale docs**: The root `README.md` is untouched create-next-app boilerplate. `docs/design/design-web.md` and `docs/design/design-mobile.md` predate the 2026-07 feed/comments/text-posts overhaul — trust tokens and primitives, but verify page patterns against current code (see the note in `docs/design/design.md`).
